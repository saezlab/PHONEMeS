...
save(file=paste("./Results_",resN(optParam),"/G",Gindex,"Results_",resN(optParam),".RData", sep=""),list=c("c.scoresG1","c.modelsG1","c.modelsG1.intAnd","c.scoresG1.list","pknList"))
